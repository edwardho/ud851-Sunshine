...
//  COMPLETE (1) Create a constant int value to identify the notification
    private static final int WEATHER_NOTIFICATION_ID = 4564;
    private static final int WEATHER_PENDING_INTENT_ID = 9234;
...
//          COMPLETE (4) Use TaskStackBuilder to create the proper PendingIntent
            ...
            PendingIntent contentIntent = taskStackBuilder
                    .getPendingIntent(WEATHER_PENDING_INTENT_ID, PendingIntent.FLAG_UPDATE_CURRENT);

//          COMPLETE (5) Set the content Intent of the NotificationBuilder
            notificationBuilder.setContentIntent(contentIntent);

            // Setting notification priority if version between Jellybean and O
