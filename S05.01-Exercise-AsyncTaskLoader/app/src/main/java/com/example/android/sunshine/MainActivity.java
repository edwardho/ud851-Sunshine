...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    // Constant value to identify forecast loader
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get loader by calling getLoader and passing the ID specified
        LoaderManager loaderManager = getSupportLoaderManager();
        Loader<String[]> forecastLoader = loaderManager.getLoader(FORECAST_LOADER);

        // If loader is null, initialize it, else restart it
    ...
    public Loader<String[]> onCreateLoader(int i, @Nullable final Bundle bundle) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            protected void onStartLoading() {
                // If there is no weather data populated
                if (mWeatherData == null) {
                    // Show loading indicator
                    mLoadingIndicator.setVisibility(View.VISIBLE);
                    // Force load to get data
                    forceLoad();
                }
                // Else, deliver the results of the populated data
                else {
            ...
            public String[] loadInBackground() {
                ...
                if (SunshinePreferences.getPreferredWeatherLocation(MainActivity.this) == null) {
                    return null;
                }
    ...
    public void onLoaderReset(@NonNull Loader<String[]> loader) {
        // Not using this method but it was required to properly implement the LoaderCallback<String[]> Interface
    }
