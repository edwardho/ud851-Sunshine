...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String prefWeatherLocation = sharedPreferences.getString(prefLocationKey, prefLocationDefault);
        return prefWeatherLocation;
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String prefUnitKey = context.getString(R.string.pref_units_key);
        String prefUnitDefault = context.getString(R.string.pref_units_metric);
        String prefWeatherUnit = sharedPreferences.getString(prefUnitKey,prefUnitDefault);
        String metric = context.getString(R.string.pref_units_metric);

        Boolean metricPreferred;

        if (prefWeatherUnit.equals(metric)) {
            metricPreferred = true;
        }
        else {
            metricPreferred = false;
        }
